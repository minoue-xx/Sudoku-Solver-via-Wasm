...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 205914112;
...
assert(INITIAL_MEMORY == 205914112, 'Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically');
...
var wasmBinaryFile;
  wasmBinaryFile = 'solveSudokuImage_codegen.wasm';
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 205914112);
...
/** @type {function(...*):?} */
var _solveSudokuImage_codegen_initialize = Module["_solveSudokuImage_codegen_initialize"] = createExportWrapper("solveSudokuImage_codegen_initialize");

/** @type {function(...*):?} */
var _solveSudokuImage_codegen_terminate = Module["_solveSudokuImage_codegen_terminate"] = createExportWrapper("solveSudokuImage_codegen_terminate");

/** @type {function(...*):?} */
var _solveSudokuImage_codegen = Module["_solveSudokuImage_codegen"] = createExportWrapper("solveSudokuImage_codegen");
